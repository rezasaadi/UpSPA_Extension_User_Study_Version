declare module '../wasm-pkg/upspa_wasm.js' {
  ...
  export function toprf_server_eval_wasm(blinded: string, share: string): string;
  ...
  export function protocol_migrate_existing(
    uid: string,
    lsj: string,
    state_key: string,
    cid: unknown,
  ...
  export function protocol_secret_update_finish(
    uid: string,
    lsj: string,
    k0: string,
    cjs: unknown,
