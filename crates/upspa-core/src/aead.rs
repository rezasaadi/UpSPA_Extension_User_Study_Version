use crate::types::{CtBlob, DynamicCtBlob, UpspaError, NONCE_LEN, TAG_LEN};
...
pub fn xchacha_encrypt_detached_dynamic(
    key: &[u8; 32],
    aad: &[u8],
    plaintext: &[u8],
    rng: &mut impl RngCore,
...
pub fn xchacha_decrypt_detached_dynamic(
    key: &[u8; 32],
    aad: &[u8],
    blob: &DynamicCtBlob,
