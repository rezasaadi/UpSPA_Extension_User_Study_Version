...
// Keep the protocol inputs explicit at this boundary; grouping them would obscure
// the operation's wire-level parameters without reducing caller complexity.
